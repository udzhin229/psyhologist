...
<html lang="en">
  ...
  <div class="page">
        ...
        <section>
          <div class="container">
            <div class="section__inner">
              <div class="head">
                <div class="title">Задайте любой вопрос нашим проффесиональным психологам</div>
                <div class="like" id="like" onclick="window.location.href='/psychologist/compare.php'"></div>
              </div>
              <div class="blocks">
                <?php
                foreach ($psyho as $row) {
                  echo '
                  <div class="block" data-psychologist-id="'.$row['id'].'">
    ...
    if (comparePsychologists) {
      ...
      if (comparePsychologists.length > 0) {
    ...
    $('.like-fill').click(function() {
      ...
      // Обновляем состояние элемента #like
      if (comparePsychologists.length > 0) {
        $('#like').addClass('active');
      } else {
        $('#like').removeClass('active');
